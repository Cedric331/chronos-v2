                                        ...
                                        <div v-for="planning in day.plannings" :key="planning" class="flex flex-col p-2 min-h-[11rem]">
                                            ...
                                            <div class="flex justify-center">
                                                <div class="flex items-center flex-wrap gap-2">
                                                    ...
                                                    <div v-if="planning.rotation" class="inline-flex items-center px-2 py-0.5 rounded-md text-xs font-medium bg-white/80 dark:bg-gray-700/80 text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-600 backdrop-blur-sm">
                                                        {{ planning.rotation.name }}
                                                    </div>
                                                    <div :id="'event-'+day.id" v-if="planning.event_plannings.length" class="font-bold">
