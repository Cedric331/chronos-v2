    ...
    <Modal :show="showRotation" maxWidth="4xl">
        <div class="mx-auto w-full border p-4">
            <div class="mt-6 flex justify-between">
                <div>
                    <label for="name" class="block mb-2 text-lg font-medium" :class="$store.state.isDarkMode ? 'text-white' : 'text-black'">*Nom de la Rotation</label>
                ...
                <div class="border-t-0 px-6 align-middle border-l-0 border-r-0 flex justify-between p-4">
                    <label class="inline-flex items-center mt-3">
                        <input v-model="synchronise" :checked="synchronise" type="checkbox" class="form-checkbox h-5 w-5"><span class="ml-2" :class="$store.state.isDarkMode ? 'text-white' : 'text-black'">Synchroniser les jours</span>
                    </label>
                </div>
            </div>
            ...
            <div class="mt-6">
                <div class="block w-full overflow-x-auto">
                    <table class="items-center bg-transparent w-full border-collapse ">
                        <thead>
                        <tr>
                            <th class="px-6  align-middle border border-solid border-blueGray-100 py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-left" :class="$store.state.isDarkMode ? 'text-white' : 'text-black'">
                                Jour de la semaine
                            </th>
                            <th class="px-6  align-middle border border-solid border-blueGray-100 py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-left" :class="$store.state.isDarkMode ? 'text-white' : 'text-black'">
                                Jour OFF
                        ...
                        <tr v-for="(jour, days) in jours" :key="days">
                            <th class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-lg whitespace-nowrap p-4 text-left  font-bold" :class="$store.state.isDarkMode ? 'text-white' : 'text-black'">
