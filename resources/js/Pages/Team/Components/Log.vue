    ...
    <div class="h-auto bg-gray-300 dark:bg-gray-800 p-5" :style="{ backgroundColor: this.$store.state.isDarkMode ? '' : $page.props.auth.team.params.color1 }">
        <div class="p-4 sm:p-6 xl:p-8 ">
            ...
            <div class="flex flex-col items-center mt-10">
             ...
             <span class="font-semibold text-gray-900 dark:text-white">{{ total_count }}</span> Résultats
            </span>
                <div class="inline-flex mt-2 xs:mt-0">
                    <a v-if="prev_page_url" @click.prevent="loadPage(prev_page_url)" class="flex items-center cursor-pointer justify-center px-3 h-8 text-sm font-medium text-white bg-gray-800 rounded-l hover:bg-gray-900 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
