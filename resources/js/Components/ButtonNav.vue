    ...
    <div>
        ...
        <div class="fixed bottom-4 right-4 z-50">
            ...
            <div v-if="$page.props.auth.isCoordinateur"
                ...
                <button @click.prevent="this.$emit('showModalTeam')"
                        id="infoTeam"
                        class="bg-[#FD7272] px-3 py-3 rounded-full text-black text-sm flex items-center justify-center cursor-pointer">
...
export default {
    components: {Loading},
    emits: ['openUpdateDay', 'planningFull', 'shareSchedule', 'showModalTeam'],
    props: {
        daySelected: Object
    },
    data() {
    ...
    mounted() {
        ...
        tippy('#infoTeam', {
            placement: 'left',
            content: 'Information sur la team',
        });
    }
}
</script>
