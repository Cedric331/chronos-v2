<template>
    <div>
        ...
        <div class="fixed bottom-4 right-4 z-50">
            ...
            <!-- Bouton fixe -->
            <div @click.prevent="isMenuOpen = !isMenuOpen" class="h-12 w-12 bg-[#70a1ff] rounded-full flex items-center justify-center text-white dark:text-black cursor-pointer relative">
